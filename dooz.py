...
def show_winner(winner):
    if winner == "X":
        player_points[0] +=1
        showinfo("اتمام بازي", "بازيکن شماره 1 برنده شد.")
        reset()
    else:
        player_points[1] +=1
        showinfo("اتمام بازي", "بازيکن شماره 2 برنده شد.")
        reset()
...
def check_draw():
    if "" not in results:
        showinfo("تمام بازي" , "بازي مساوي شد.")
        reset()
...
def point():
    ...
    label_player_one = tk.Label(board_frame, text="بازيکن 1", font=("aviny",16), padx=10)
    label_player_two = tk.Label(board_frame, text="بازيکن 2", font=("aviny",16), padx=10)
